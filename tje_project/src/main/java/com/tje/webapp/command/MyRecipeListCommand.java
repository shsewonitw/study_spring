...
import tje.model.*;
import tje.dao.*;
public class MyRecipeListCommand extends Command {

	private String formPage = "/WEB-INF/forms/myRecipeList.jsp";
	...
	protected String processForm(HttpServletRequest request, HttpServletResponse response) {
		...
		try(Connection conn = ConnectionProvider.getConnection()) {
			ArrayList<SimpleRecipe> result = simpleRecipeDAO.selectFromMember_id(conn, simpleRecipe);
			request.setAttribute("myRecipeList", result);
